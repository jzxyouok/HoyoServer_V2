...
class DatePickerDialog: UIView {
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: NSDate = NSDate(), datePickerMode: UIDatePickerMode = .DateAndTime,
              formate: String,callback: DatePickerCallback) {
        ...
        let dateAndTime=dataFormatter.stringFromDate(defaultDate)
        self.datePicker.date = dateFromTimeString(dateAndTime)
        
//            let select=datePicker.date
//            let dataFormatter=NSDateFormatter()
//            dataFormatter.dateFormat="HH:mm"
//            let dateAndTime=dataFormatter.stringFromDate(select)
//            print(dateAndTime)
//            setTime2.text=dateAndTime
...
//    setTime2.text=dateAndTime
    ...
    func buttonTapped(sender: UIButton!) {
        if sender.tag == kDatePickerDialogDoneButtonTag {
                ...
                print(dateAndTime)
              //  setTime2.text=dateAndTime
            self.callback?(date: dateAndTime)
        }
